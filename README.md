...
| `dm.md` | Стиль лички |
| `public.md` | Стиль публичных поверхностей (комменты, канал) |
| `facts.md` | База знаний: услуги, цены, FAQ — секретарь опирается, не выдумывает |
...
| [docs/saas-architecture.md](./docs/saas-architecture.md) | SaaS: мультиарендность — решение, фазы, модель данных |
